...
import {Tecnoking} from './tecnoking';
import {Tiendatr} from './tiendatr';
...
export const storeList = new Map([
  ...
  [Infobarna.name, Infobarna],
  [Izarmicro.name, Izarmicro],  
  ...
  [Tecnoking.name, Tecnoking],
  [Tiendatr.name, Tiendatr],
